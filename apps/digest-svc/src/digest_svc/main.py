...
from .api.v1.routes_digest import router as digest_router
from .config import DigestSvcSettings
from .deps import get_db, get_settings

settings = DigestSvcSettings()
...
async def version() -> dict[str, str]:
    return {"service": "digest-svc", "version": "0.1.0"}
